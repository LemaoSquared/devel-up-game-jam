...
func play_story_pattern(number: int):
	...
	var item_count = []
	match number:
		1: item_count = [15, 0, 0, 0, 0, 0, 0, 0, 0, 0]
		2: item_count = [15, 0, 0, 0, 0, 0, 0, 0, 0, 0]
		3: item_count = [20, 0, 5, 0, 0, 0, 0, 0, 0, 0]
		4: item_count = [20, 0, 5, 0, 0, 0, 0, 0, 0, 0]
		5: item_count = [0, 20, 0, 0, 0, 0, 0, 0, 0, 0]
		6: item_count = [10, 10, 0, 0, 0, 0, 0, 0, 0, 0]
		7: item_count = [15, 15, 5, 0, 0, 0, 0, 0, 0, 0]
		8: item_count = [0, 30, 5, 0, 0, 0, 0, 0, 0, 0]
		9: item_count = [0, 0, 15, 1, 0, 0, 0, 0, 0, 0]
		10: item_count = [0, 0, 15, 1, 0, 0, 0, 0, 0, 0]
		11: item_count = [10, 0, 0, 0, 0, 5, 0, 0, 0, 0]
		12: item_count = [0, 10, 0, 0, 0, 5, 0, 0, 0, 0]
		13: item_count = [0, 25, 0, 0, 5, 0, 0, 0, 0, 0]
		14: item_count = [25, 0, 0, 0, 5, 0, 0, 0, 0, 0]
		15: item_count = [0, 4, 0, 0, 5, 7, 0, 0, 0, 0]
		16: item_count = [7, 0, 5, 0, 0, 6, 0, 0, 0, 0]
		17: item_count = [17, 0, 0, 0, 0, 0, 2, 0, 0, 0]
		18: item_count = [0, 17, 0, 0, 0, 0, 2, 0, 0, 0]
		19: item_count = [0, 0, 0, 1, 0, 25, 0, 0, 0, 0] 
		20: item_count = [0, 0, 0, 1, 10, 0, 15, 0, 0, 0]
		21: item_count = [0, 0, 10, 0, 0, 10, 0, 0, 0, 0]
		22: item_count = [6, 0, 0, 0, 10, 0, 6, 0, 0, 0]
		23: item_count = [15, 0, 0, 0, 0, 0, 0, 2, 0, 0]
		24: item_count = [0, 1, 0, 0, 0, 8, 0, 1, 0, 0]
		25: item_count = [20, 0, 20, 1, 0, 0, 0, 0, 0, 0]
		26: item_count = [0, 20, 0, 1, 20, 0, 0, 0, 0, 0]
		27: item_count = [10, 0, 10, 0, 0, 0, 0, 3, 0, 0]
		28: item_count = [4, 0, 0, 0, 10, 12, 0, 0, 0, 0]
		29: item_count = [0, 14, 15, 0, 0, 12, 0, 0, 0, 0]
		30: item_count = [20, 0, 0, 0, 15, 0, 0, 3, 0, 0]
